...
X, y = make_regression(n_samples=5000, n_features=12, noise=1, random_state=42)
...
def get_explanation():
    ...
    ret = [ {"feature_name": f"F{i}", "importance": value}  for i, value in enumerate(total_importance_per_feature.tolist())]
